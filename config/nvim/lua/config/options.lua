...
if #vim.api.nvim_list_uis() == 0 then
  ...
  options.opt = {
    ...
    updatetime = 100, -- [go] Time in milliseconds to wait before triggering the 'updatetime' event (reduced from 250)
...
end) -- [go] Use the system clipboard for all yank, delete, change and put operations
