...
vim.opt.guicursor = {                                                           -- Cursor Settings (default "n-v-c-sm:block,i-ci-ve:ver25,r-cr-o:hor20,t:block-blinkon500-blinkoff500-TermCursor")
...
vim.opt.indentexpr = "v:lua.require'nvim-treesitter'.indentexpr()"              -- Use treesitter for indentation (https://github.com/nvim-treesitter/nvim-treesitter?tab=readme-ov-file)

-- FOLDING SETTINGS
vim.opt.foldcolumn = '0'                                                        -- When and how to draw the foldcolumn: "0": disable (GOOD!); "auto": resize to the minimum amount of folds to display; "auto:[1-9]": resize to accommodate multiple folds up to the selected level; "[1-9]": displays a fixed col numb
...
vim.opt.foldexpr = 'v:lua.vim.treesitter.foldexpr()'                            -- Use treesitter for folding (https://github.com/nvim-treesitter/nvim-treesitter?tab=readme-ov-file#folding)
...
vim.g.python3_host_prog = paths.bin_for_python3_venv()          -- Python 3 host program
