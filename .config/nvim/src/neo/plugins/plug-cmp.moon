...
require('neo/lib/functions/imports') 'cmp', (cmp) ->
  require('neo/lib/functions/imports') 'lspkind', (lspkind) ->
    feedkeys = require 'core/map/feed_keys'
    has_words_before_cursor = require 'neo/lib/functions/has_words_before_cursor'
    source_mapping = {
      vsnip: '🔖 vsnip',
      buffer: '⚗️ buffer',
      nvim_lua: '🌙 nvim',
