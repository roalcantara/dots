...
require('neo/lib/functions/imports') 'trouble', (plugin) ->
  plugin.setup({
    ...
    action_keys: { -- key mappings for actions in the trouble list
      -- key mappings. map to {} to remove a mapping, for example: close: {}
    ...
    auto_preview: false, -- automatically preview the location of the diagnostic. <esc> to close
    auto_fold: false, -- automatically fold a file trouble list at creation
    auto_jump: {'lsp_definitions'}, -- for the given modes, automatically jump if there is only a single result
    signs: {
      error: '', -- icons / text used for a diagnostic
      warning: '',
      hint: '',
      information: '',
      other: '﫠'
