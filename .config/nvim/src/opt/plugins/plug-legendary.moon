...
_G.imports 'legendary', (plugin) ->
  ...
  plugin.setup({
    ...
    commands: {
      ...
      { ':Maps',      fzf('keymaps'),       description: ' Show mappings' },
      { ':Commands',  fzf('commands'),      description: ' Show commands' },
      ...
      { ':Files',     fzf('files'),         description: ' Find file' },
    ...
    keymaps: {
      ...
      { '<Enter>',    { n: cm(esc('0')),          i: cm(esc('0'))                                }, description: 'Go to the beginning of the next line' },
      { '<D-C-v>',    { n: cw('<C-v>'),           i: esc(cw('<C-v>'))                            }, description: ' Vertial split' },
      { '<A-Right>',  { n: '2e',                  i: esc('2e'),        v: esc('2e')              }, description: 'To after the next word' },
      { '<D-Right>',  { n: '$',                   i: esc('$'),         v: esc('$')               }, description: 'Go to the end of line' },
      { '<D-Left>',   { n: '0',                   i: esc('0'),         v: esc('0')               }, description: 'Go to the start of line' },
