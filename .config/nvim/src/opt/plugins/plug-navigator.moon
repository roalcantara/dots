...
_G.imports 'navigator', (plugin) ->
  ...
  plugin.setup({
    ...
    lsp: {
      ...
      -- lua_ls: {
      --   sumneko_root_path: path.lsp.path_to('sumneko/lua-language-server'),
      --   sumneko_binary: path.lsp.path_to('sumneko/lua-language-server/bin/macOS/lua-language-server/ lua_ls/extension/server/bin/lua-language-server')
      -- },
