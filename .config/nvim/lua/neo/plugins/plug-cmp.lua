return require('neo/lib/functions/imports')('cmp', function(cmp)
  return require('neo/lib/functions/imports')('lspkind', function(lspkind)
    local feedkeys = require('core/map/feed_keys')
    local has_words_before_cursor = require('neo/lib/functions/has_words_before_cursor')
