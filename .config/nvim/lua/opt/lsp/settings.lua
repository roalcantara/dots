local handlers = require('opt/lsp/handlers')
local capabilities = require('opt/lsp/capabilities')
local server_config = require('etc/fn/path').lsp.config
local set_buf_keymap = require('etc/map/set_buf_keymap').set_buf_keymap
local opts = {
  noremap = true,
  silent = false
}
