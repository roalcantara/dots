local isNullOrEmpty = require('etc/lang/is_null')
...
local vi = {
  ...
  put = require('etc/fn/put'),
  sys = require('etc/fn/system'),
  setup = {
    global_variables = require('etc/fn/options/global_variables'),
    opts = require('etc/fn/options/opts')
  }
}
return vi
