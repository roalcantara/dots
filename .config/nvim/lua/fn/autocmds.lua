...
local get_format_on_save_opts = function()
  local defaults = require('neo/config/defaults').format_on_save
...
function M.enable_format_on_save()
  ...
  vim.api.nvim_create_autocmd('BufWritePre', {
    ...
    callback = function()
      require('neo/lsp.utils').format { timeout_ms = opts.timeout, filter = opts.filter }
    end,
  })
  log 'enabled format-on-save'
end

function M.disable_format_on_save()
  M.clear_augroup 'lsp_format_on_save'
  log 'disabled format-on-save'
end
...
function M.clear_augroup(name)
  ...
  log('request to clear autocmds  ' .. name)
